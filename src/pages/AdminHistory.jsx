...
export default function AdminHistory() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-200 items-start">
      <button
      ...
      <aside
        className={`fixed md:sticky md:top-0 md:self-start z-40 h-full md:h-screen overflow-y-auto w-64 bg-purple-400 text-white p-6 shadow-xl
