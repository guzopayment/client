...
//               <tr>
//                 <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Questionnaire ID</th>
...
//                 <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Near Church</th>
//                 <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Action</th>
//               </tr>
//             </thead>
...
//                         <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Phone</th>
//                         <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Organization</th>
//                         <th className="px-2 py-2 text-[11px] md:text-sm whitespace-nowrap">Current Job</th>
//                       </tr>
//                     </thead>
//                     <tbody>
//                       {visibleRows.map((r) => (
