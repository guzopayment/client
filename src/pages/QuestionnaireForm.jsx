  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <TopTicker
        ...
        items={[
          "እባክዎ ሁሉንም መረጃ በትክክል ይሙሉ",
          "ተመሳሳይ ሙሉ ስም በድጋሚ መመዝገብ አይቻልም",
          "ስልክ ቁጥር ሊደገም ይችላል ነገር ግን ሙሉ ስም ተለይቶ መሆን አለበት",
      ...
      <div className="min-h-[calc(100vh-40px)] flex justify-center items-center px-4 py-8 relative">
        <div className="text-center">
          <button
            type="button"
            className="absolute left-1 top-1 min-w-fit h-auto bg-white text-purple-600 p-1 rounded-xl font-bold shadow hover:scale-105 transition"
            onClick={() => navigate("/")}
          >
            {/* መመለስ */}
            <img
        ...
        >
          ...
          <h4 className="text-sm font-thin mb-5 text-green-700">
            የማዕረግ ስም ካለዎት እና የክርስትና ስም የሚጠቀሙ ከሆነ የ/ ምልክት ይጠቀሙ፤ ምሳሌ ፦ ዶ/ር ሚካኤል
            ባዘዘው ፣ ዲ/ን ጋሻሁን ወ/ሚካኤል
          </h4>
          ...
          <div className="text-center text-sm font-thin mt-5 text-zinc-500">
            <h5>
              ያስገቡ የሚለውን ከመንካትዎ በፊት ትክክለኛ መረጃ መሙላትዎን ያረጋግጡ፤ ከዚያ ያስገቡ የሚለውን ይንኩ።
              እናም እባክዎ የማረጋገጫ መልዕክቱ እስኪታይ ጥቂት ይታገሱ።
            </h5>
          </div>
        </form>
